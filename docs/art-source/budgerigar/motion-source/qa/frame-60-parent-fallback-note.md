...
Parent accepted this fallback frame for the source asset after the `55-61` and
full-grid contact reviews. It keeps the yellow head, green body, visible
feet/contact, scale, and baseline better than the rejected ImageGen retries.
This is source-art acceptance only; it does not add the variant to runtime,
Pages, release notes, tags, or downloadable artifacts.
