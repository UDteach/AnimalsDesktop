...
def main() -> None:
    ...
    write_contact(list(range(0, 62)), "lovebird-peach-faced-00-61")
    write_contact(list(range(45, 62)), "lovebird-peach-faced-45-61")
    write_contact(list(range(53, 62)), "lovebird-peach-faced-53-61")
    (QA / "prepare-report-53-61.json").write_text(json.dumps(report, indent=2), encoding="utf-8")
