...
def main() -> None:
    ...
    write_contact(list(range(0, 37)), "lovebird-peach-faced-00-36")
    write_contact(list(range(29, 37)), "lovebird-peach-faced-29-36")
    (QA / "prepare-report-29-36.json").write_text(json.dumps(report, indent=2), encoding="utf-8")
