...
def main() -> None:
    ...
    write_contact(list(range(0, 21)), "lovebird-peach-faced-00-20")
    write_contact(list(range(13, 21)), "lovebird-peach-faced-13-20")
    (QA / "prepare-report-13-20.json").write_text(json.dumps(report, indent=2), encoding="utf-8")
