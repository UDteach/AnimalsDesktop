...
def main() -> None:
    ...
    write_contact(list(range(0, 53)), "lovebird-peach-faced-00-52")
    write_contact(list(range(45, 53)), "lovebird-peach-faced-45-52")
    (QA / "prepare-report-45-52.json").write_text(json.dumps(report, indent=2), encoding="utf-8")
